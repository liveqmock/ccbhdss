...
<html>
  <head><title></title>
    ...
    <%
       ...
       String strSql =  "select OpnBankNo,CKind,AccNo,Name,RegDate,IDName,IDNo,TellerNo1,AgentNo,NewAccNo,canceldate " +
       ...
       dbGrid.setField("解挂日期","text","8","canceldate","true","0"); 
