...
<script language="javascript" src="dgdqDataQry.js"></script>
<html>
<head><title></title>
    <script language="javascript" src="dgdqDataQry.js"></script>
    <%
        ...
        if(!"1".equalsIgnoreCase(isSuper)){
            strSql += " and tcan.td_opac_instn_no='"+operId+"'";
        }
        ...
        dbGrid.setField("存单利率", "text", "14", "td_tdp_intr", "true", "0");
        dbGrid.setField("存期", "text", "13", "td_dep_prd_n", "true", "0");
        dbGrid.setField("到期日期", "text", "8", "td_due_dt", "true", "0");
        dbGrid.setField("结清日期", "text", "8", "td_clsd_dt", "true", "0");
        dbGrid.setField("开户柜员号", "text", "16", "td_opac_tlr_no", "true", "0");
        dbGrid.setField("开户机构名", "text", "18", "opac_inil_1_chn", "true", "0");
        dbGrid.setField("开户金额", "text", "8", "td_opac_amt", "true", "0");
        dbGrid.setField("开户日期", "text", "8", "td_opac_dt", "true", "0");
        dbGrid.setField("客户编号", "text", "18", "td_cust_no", "true", "0");
         dbGrid.setField("实际金额", "text", "8", "td_actu_amt", "true", "0");
        dbGrid.setField("销户柜员号", "text", "16", "td_opac_tlr_no", "true", "0");
        dbGrid.setField("销户机构名", "text", "18", "opac_inil_2_chn", "true", "0");
        dbGrid.setField("帐户状态", "dropdown", "8", "td_acct_sts", "true", "HISACCTSTS");
        dbGrid.setField("结清利息", "text", "8", "td_clsd_int", "true", "0");
        dbGrid.setField("客户名称", "text", "8", "td_cust_name", "true", "0");
        ...
        <form id="queryForm" name="queryForm" method="post" action="grhqDataQry.jsp">
            <tr height="20">
                <td width="15%" align="right" nowrap="nowrap" class="lbl_right_padding">
                    ...
                    <input type="hidden" value="对公定期主档查询" id="hidRMK" name="hidRMK" />
