...
<html>
  <head><title></title>
    ...
    <%
       ...
       dbGrid.setField("客户编号","text","8","sa_cust_no","true","0");
       dbGrid.setField("客户名称","text","12","sa_cust_name","true","0");
       dbGrid.setField("帐号","text","14","wb_zh","true","0");
       //dbGrid.setField("卡号","text","13","sa_card_no","true","0");
       dbGrid.setField("开户机构号","text","8","sa_opac_instn_no","true","0");
       dbGrid.setField("开户机构名","text","8","opac_inil_1_chn","true","0");
       dbGrid.setField("开户日期","text","8","sa_opac_dt","true","0");
       dbGrid.setField("销户机构号","text","8","sa_cacct_instn_no","true","0");
       dbGrid.setField("销户机构名","text","8","cacct_inil_1_chn","true","0");
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%" >
        ...
        <tr height="20">
          <td width="15%" align="right" nowrap="nowrap" class="lbl_right_padding">
              ...
              <input type="hidden" value="对公活期主档查询" id="hidRMK" name="hidRMK" />
